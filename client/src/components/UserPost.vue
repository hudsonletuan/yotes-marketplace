...
const emit = defineEmits(['open-editpost', 'close-userpost']);
const closeUserPost = () => {
    emit('close-userpost');
};
...
const fetchPosts = async () => {
    ...
    try {
        const response = await axios.get('/api/userposts', { params: { limit, skip: skip.value, username: props.username } });
...
<template>
    <div class="wrapper">
        <div class="close-btn" @click="closeUserPost">&#10006;</div>
